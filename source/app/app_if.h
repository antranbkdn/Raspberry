...
/*****************************************************************************/
/*  query channel define
 */
/*****************************************************************************/
#define GW_GW_CHANNEL_QUE_US                        (19)
#define GW_GW_CHANNEL_RES_US                        (20)
#define GW_START_QUERRY_CHANNEL                     (21)
#define GW_GW_CHANNEL_RES_TIMEOUT                   (22)
/*****************************************************************************/
/*  query address define
 */
/*****************************************************************************/
#define DV_ADDRESS_QUE_US                           (31)
#define ADDRESS_RES_US                              (32)
 ...
 * digital mqtt define
 *****************************************************************************/
#define GW_SV_DIGITAL_STATE_RES_US                  (9)
#define GW_SV_DIGITAL_STATE_UPDATE_US               (10)
#define SV_GW_DIGITAL_CTL_US                        (11)

/*****************************************************************************
 *  register device define
 *****************************************************************************/
#define DV_GW_REGISTER_REQ_US                       (1)
#define GW_DV_REGISTER_RES_US                       (2)
#define DV_GW_REGISTER_FN_US                        (3)
#define GW_DV_KEY_EXCHANGE_US                       (4)
#define GW_DV_REGISTER_RES_AFTER_GW_CHANNEL_US      (5)

#define GW_DV_BROADCAST_DF_CHANNEL_US               (6)
#define GW_DV_BROADCAST_GW_CHANNEL_US               (7)
#define DV_GW_REGISTER_RES_US_TIMEOUT               (8)
 ...
 */
/*****************************************************************************/
#define DV_GW_DIGITAL_STATE_UPDATE_US               (7)
#define DV_GW_DIGITAL_STATE_RES_US                  (8)
#define GW_SV_DIGITAL_STATE_US                      (9)
#define GW_DV_DIGITAL_CTL_US                        (10)
#define SV_GW_DIGITAL_CTL_US                        (11)
#define TIME_OUT                                    (13)
